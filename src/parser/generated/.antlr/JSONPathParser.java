...
public class JSONPathParser extends Parser {
	...
	public static final int
		...
		SIZ=19, NOT=20, OR=21, TRUE=22, FALSE=23, NULL=24, BRACE_LEFT=25, BRACE_RIGHT=26, 
		BRACKET_LEFT=27, BRACKET_RIGHT=28, COLON=29, COMMA=30, PAREN_LEFT=31, 
		PAREN_RIGHT=32, QUESTION=33, MINUS_SP=34, PLUS=35, DIV=36, FN_LEN=37, 
		REGEX_OPT=38, REGEX_EXPR=39, KEY=40, SPECIAL_KEY=41, WS=42, NUMBER=43, 
		STRING=44;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"QUESTION", "MINUS_SP", "PLUS", "DIV", "FN_LEN", "REGEX_OPT", "REGEX_EXPR", 
	...
	public final JsonpathContext jsonpath() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 134217748L) != 0)) {
				{
				setState(41);
				subscript();
				}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				setState(167);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1040256L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			...
			setState(192);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 3298564243456L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
